...
public class Mon_Goblin_Bow : Mon_Bass
{

    protected StateMachine<Mon_Goblin_Bow> _stateMachine = null;
    ...
    public override void Init()
    {
            ...
            _stateMachine = new StateMachine<Mon_Goblin_Bow>(this);
   ...
   protected void CreateArrow()
    ...
    private class IdleState : State<Mon_Goblin_Bow>
    {
    ...
    private class RunState : State<Mon_Goblin_Bow>
    {
        protected override void Begin()
        {
    ...
    private class AttackState : State<Mon_Goblin_Bow>
    {
        protected override void Begin()
        {
    ...
    private class HitState : State<Mon_Goblin_Bow>
    {
        protected override void Begin()
        {
    ...
    private class DieState : State<Mon_Goblin_Bow>
    {
        protected override void Begin()
        {

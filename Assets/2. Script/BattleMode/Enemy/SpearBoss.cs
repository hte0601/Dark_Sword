...
namespace BattleMode
{
    public class SpearBoss : Boss
    {
        ...
        {
            bossDamage = 30 + GameManager.DebuffBossDamageUp;
            bossSpeed = 1 + GameManager.DebuffBossSpeedUp;
            phase = GameManager.DebuffBossStartPhase;
        ...
        protected override void Update()
        {
            ...
            if (DistanceFromPlayer() > 3 && (getState() == State.Run || getState() == State.Idle))
            {
                MoveToPlayer();
                setState(State.Run);
                SoundManager.EnemyFootSound();
            }
            else if (getState() == State.Run)
            {
                setState(State.Idle);
                SoundManager.EnemyWalkingSoundStop();
            }
        }
        ...
        IEnumerator PierceAttackAnimation()
        {
            ...
            SoundManager.EnemyPierceAttackSound();
        ...
        IEnumerator DownAttackAnimation()
        {
            ...
            isAlreadyDamage = false;
            SoundManager.EnemyDownAttackSound();
        ...
        IEnumerator ThrowAndBackStepAnimation()
        {
            ...
            ParticleManager.CreateLandingParticle();
            SoundManager.EnemyLandingSound();
        ...
        IEnumerator RushAnimation()
        {
            ...
            isAlreadyDamage = false;
            isGroggyAttack = true;
            ParticleManager.CreateRushParticle();
        ...
        IEnumerator ThrowSpear()
        {
            ...
            SoundManager.EnemyThrowSpearSound();
            ...
            ParticleManager.CreateThrowSpearParticle(SpearHitPoint.transform.position);
            SoundManager.EnemyWeaponSound();
        ...
        void Start2Phase()
        {
            ...
            ParticleManager.CreateEnemyPhaseChangeParticle();
            SoundManager.EnemyPhaseChangeSound();
        }

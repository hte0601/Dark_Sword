...
public class Mon_Goblin :Mon_Bass
{

    protected StateMachine<Mon_Goblin> _stateMachine = null;
    ...
    public override void Init()
    {
             ...
             _stateMachine = new StateMachine<Mon_Goblin>(this);
    ...
    private class IdleState : State<Mon_Goblin>
    {
    ...
    private class RunState : State<Mon_Goblin>
    {
        protected override void Begin()
        {
    ...
    private class AttackState : State<Mon_Goblin>
    {
        protected override void Begin()
        {
    ...
    private class HitState : State<Mon_Goblin>
    {
        protected override void Begin()
        {
    ...
    private class DieState : State<Mon_Goblin>
    {
        protected override void Begin()
        {
